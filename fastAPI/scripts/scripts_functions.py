...
#-----------------------------------------------------------------------
# plot frontier, max sharpe & min Volatility values with a scatterplot
def plot_weights (actual_portfolio_df, tickers_list, min_variance_port, sharpe_portfolio, min_volatility_for_return,max_return_for_volatility):
...
def optimize_potfolio(df: pd.DataFrame, tickers_list:list[str], weights_list:list[int]):
    ...
    random_portfolios_df = random_portfolios(tickers_list, returns_annual, cov_annual)
    ...
    plot_weights(actual_portfolio_df, tickers_list, min_variance_port, sharpe_portfolio, min_volatility_for_return,max_return_for_volatility)
